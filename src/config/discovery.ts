...
export const DISCOVERY = {
  ...
  excludedCoingeckoCategories: [
    ...
    // Обёртки на чужой актив: своей экономики нет, сравнивать не с чем и незачем.
    // 38 акций и 44 фонда во вселенной; 37 из них сидели в пробелах покрытия.
    // Это уменьшение знаменателя, и оно отчитывается количеством в warnings.
    'tokenized-stock',
